        ...
        <div class="hidden w-28 bg-indigo-700 overflow-y-auto md:block">
            <div class="w-full py-6 flex flex-col items-center">
                ...
                <div class="flex-1 mt-6 w-full px-2 space-y-1">
                    <router-link v-for="(item, index) in sidebarNavigation" @click="changeCurrent(index)"
                        ...
                        <div class="relative max-w-xs w-full bg-indigo-700 pt-5 pb-4 flex-1 flex flex-col">
                            ...
                            <div class="mt-5 flex-1 h-0 px-2 overflow-y-auto">
                                <nav class="h-full flex flex-col">
                                    <div class="space-y-1">
                                        <router-link v-for="(item, index) in sidebarNavigation"
                                            @click="mobileMenuOpen = false; changeCurrent(index)" :key="item.name"
                                            :to="item.to"
